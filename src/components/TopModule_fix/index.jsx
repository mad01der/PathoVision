    ...
    return (
      <>
        <Row>
          ...
          <Col span={1}>
            <Button className="e-button" type="primary" onClick = {this.showModal}>Tips</Button>
          </Col>

          {/* 医生信息 */}
          <Row offset={1} span={7}>
            <Space direction="horizontal" style={{ marginTop: '0px' }}>
              <Text className="siderFont">Docker Name:</Text>
              <Text className="siderFont">Tom</Text>
              <Text className="siderFont">Docker ID:</Text>
              <Text className="siderFont">1934567</Text>
            </Space>
            <Space  direction="horizontal">
              <Text className="siderFont">patient ID:</Text>
              <Text className="siderFont">20240415110</Text>
              <Text className="siderFont">report ID:</Text>
              <Text className="siderFont">20240415110-0001</Text>
            </Space>
          </Row>
          ...
          <Col span={6} style={{ textAlign: 'right' }}>
            ...
            <Link to="../Data/">
              <Button className="e-button" type="primary">Back</Button>
            </Link>
          </Col>
        </Row>
        <Modal
