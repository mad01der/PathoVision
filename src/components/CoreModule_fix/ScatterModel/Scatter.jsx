      ...
      <>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            {this.state.dataToShow.map((imageUrl, index) => (
              <div key={index} style={{ width: '12.5%', marginBottom: '20px', padding: '0 10px' }}>
                <img src={process.env.REACT_APP_IMAGE_PATH + "/image_" + this.state.selectedWSI + "/" + imageUrl.split("_").slice(0, 4).join("_") + ".png"}  style={{ maxWidth: '100%', height: 'auto' }} />
        ...
        <Row id="scatterRow">
          ...
          <Affix style={{ position: 'fixed', bottom: 300, right: 300 }}>
            <Button onClick = {this.openDraw}type="primary" shape="rect">Edit noise slice labels</Button>
          </Affix>
          <Affix style={{ position: 'fixed', bottom: 300, right: 30 }}>
            <Button onClick = {this.showDetails}type="primary" shape="rect">Check details</Button>
          </Affix>
        </Row>
        ...
        <Modal
          title="Noise Slice Modification Page"
        ...
        >
          <Col style={{ marginBottom: '10px' }}>
            <Text style={{ marginTop: '10px' }}>
              WSI id : WSI-{this.state.selectedWSI}
            </Text>
          </Col>
          ...
          <Row gutter={[0, 1]} justify="space-around" align="small">
            <Col span={10} offset={2}>
                <Image style = "small"
                  ...
                  src={process.env.REACT_APP_IMAGE_PATH + "/image_" + this.state.selectedWSI + "/" + this.state.result}
                  alt={`Selected Image`}
            ...
            <Col span={24}>
              <Descriptions layout="vertical" size="small" column={4} bordered>
                <Descriptions.Item span={2} label="Reference values: Bmm and PR scores">
                  <ReactECharts
                    style={{ width: 190, height: 80 }}
                    option={this.state.barOption}
                  />
                </Descriptions.Item>
                <Descriptions.Item span={2} label="Reference values: Bmm and PR iterative change trends">
                  <ReactECharts
                    style={{ width: 200, height: 110 }}
                    option={this.state.areaOption}
                  />
                </Descriptions.Item>
                <Descriptions.Item span={4} label="Current labels">
                  
                 
                    <div className="demo-option-label-item">
                      {this.state.recentclass === 1 && <Tag color={category_color[0]}>no cancer</Tag>}
                      {this.state.recentclass === 2 && <Tag color={category_color[1]}>cancer</Tag>}
                      {this.state.recentclass === 3 && <Tag color={category_color[2]}>high cancer</Tag>}
                    </div>
                  
                
                </Descriptions.Item>
                <Descriptions.Item span={4} label="update target label">
                  <Select
                    style={{ width: "100%" }}
